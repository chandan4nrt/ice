...
export const SIDEBAR_MENU = {
  ...
  RETAILER: [
    { id: 501, path: "/retailer/dashboard", component: "RetailerDashboard", label: "Dashboard" },
    { id: 502, path: "/retailer/create-orders", component: "CreateOrder", label: "Create Orders" },
    { id: 503, path: "/retailer/order-list", component: "OrderList", label: "Order List" },
    { id: 504, path: "/retailer/payment-detail", component: "PaymentDetail", label: "Payment Detail" }
  ],
};
